    ...
    _connection.input!.listen((data) {
      ...
      while (true) {
        ...
        if (index >= 0 && _buffer.length - index >= 7) {
          ...
          samples.add(sample);
          notifyListeners(); // Note: It shouldn't be invoked very often - in this servo_app data comes at every second, but if there would be more data, it should update (including repaint of graphs) in some fixed interval instead of after every sample.
